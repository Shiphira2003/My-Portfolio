...
const Hero: React.FC = () => {
  return (
    <section className="min-h-screen flex flex-col items-center justify-center text-center px-4 relative bg-gradient-to-br from-purple-100 via-purple-50 to-white overflow-hidden">
      {/* Soft floating glow */}
      ...
      >
        <img
          ...
          className="w-40 h-40 rounded-full border-4 border-purple-300 shadow-xl mb-6"
        />
